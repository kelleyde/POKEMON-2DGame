...
bool Engine::init(const char* title, int width, int height)
{
    ...
    // Create a player object and transfer ownership to Scene.
    scene.addObject(std::make_unique<Player>(renderer, "sprite.png"));
...
void Engine::run()
{
    ...
    while (running)
    {
        ...
        // Run per-frame logic for all scene objects.
